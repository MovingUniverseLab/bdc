...
def distortion_section(initial_distortion_correction = None):
		...
		for fp_iteration in fp_iterations:
			updated_distortion_correction = do_fp_iteration(current_distortion_correction)
...
def generate_matched_table(hubbleData,matched_star_table_name,current_distortion_correction = None,):
...
def do_fp_iteration(current_distortion_correction):
			...
			if config['generate_new_fp']:  
				generate_matched_table(matched_star_table_name ,current_distortion_correction)
